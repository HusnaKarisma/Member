	...
	<div class="col-md-9 col-xs-12 col-lg-9 ">
				<div class="row">
					<div class="col-md-12 col-xs-12 col-lg-12 ">
						<div class="tabmenu">
							<h3 class="title-tab">Multi Content </h3>
							<div class="col-md-12 col-xs-12 col-lg-12 area ">
							<?php
							$data = $kategori->getnewsmultibykategoriid();
							 ...
							 foreach ($data->results as $key => $value) {
								...
								$datainfo = $kategori->getjumlahinfografis($value[$key]->no);
							 	...
							 	?>
										<div class="col-md-12 col-xs-12 col-lg-12 artikel items-<?=$key;?> kategori"  data-newsid= 'multi<?php echo $newsid; ?>'>
								  				...
								  				<div class="panel-body">
								  						<?php 
									 						...
									 						echo  " x <span aria-hidden=\"true\" class=\"glyphicon glyphicon-picture\"></span> ";
									  						...
									  						?><span class="date">&nbsp;  <?php echo $tanggal  ?>
								</span>
												 <div class="readitpos">
					...
					<nav aria-label="Page navigation">
					  ...
					  <?php
						...
						echo paginate($bantuan->baseurl("?multi=Multicontent&&"),$c_page, $total_pages, 5);
